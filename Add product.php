...
<body class="g-sidenav-show  bg-gray-200">
      ...
      <div class="modal-dialog">
        <div class="modal-content  border border-warning border-3  rounded-3 shadow">
          <div class="modal-header bg-warning text-dark">
            <h5 class="modal-title  text-dark font-weight-bold" id="exampleModalLabel">Import Products</h5>
            <button type="button" class="btn-close bg-danger" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <div class="col-md-12">
              <label for="excelfile" class="form-label text-dark">select excel file here</label>
              <input type="file" name="excelfile" id="excelfile" required value="" class="form-control ">
            </div>

            <div class="modal-footer">
              <!-- <button type="submit" name="import" class="btn btn-primary ">Import</button> -->
              <input type="submit" id="submit7" value="Import" class="btn btn-primary">
  ...
  <form id="importform" method="post" enctype="multipart/form-data">
    <div class="modal fade" id="ImportModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content  border border-warning border-3  rounded-3 shadow">
          <div class="modal-header bg-warning text-dark">
            <h5 class="modal-title  text-dark font-weight-bold" id="exampleModalLabel">Import File</h5>
            <button type="button" class="btn-close bg-danger" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>

          <div class="modal-body">
            <label for="importexcel" class="form-label">Import excel file</label>
            <input type="file" class="form-control" id="importexcel" name="importexcel" placeholder="Choose " required>
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-warning" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-info" href="Add product.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="card">
        <div class="container">
          ...
          <div class="card-body px-4">
            <h5 class="card-title">Insert Product Details</h5>
            <form class="row g-3 here" id="Addform" method="post">
            </form>
            <div id="here">
              <input type="button">
            </div>
  ...
  <div class="position-fixed top-1 end-1 z-index-2">
    <div class="toast fade hide p-2 bg-white" role="alert" aria-live="assertive" id="successToast3" aria-atomic="true">
    ...
    <div class="position-fixed top-1 end-1 z-index-2">
      ...
      <div class="position-fixed top-1 end-1 z-index-2">
        ...
        <div class="position-fixed top-1 end-1 z-index-2">
          <div class="toast fade hide p-2 bg-white" role="alert" aria-live="assertive" id="ImportToast" aria-atomic="true">
            <div class="toast-header border-0">
              <i class="material-icons text-success me-2">
                check
              </i>
          ...
          <script>
            ...
            window.Parsley.addValidator('lte', {
              ...
              messages: {
                en: 'This value should be lessthan or equal to product quantity',
          ...
          <script>
            $(document).ready(function() {
              ...
              //     var newtype = $("#editproducttype").val();
              //     var editid = $("#hiddenedit").val();
              //     $.ajax({
              //       url: "backend/Configfunction.php",
              //       type: "post",
              //       data: {
              //         newtype: newtype,
              //         editid: editid
          ...
          <script>
            function Viewinput() {
              ...
              $.ajax({
                ...
                success: function(data, status) {
                  $(".here").html(data);
                  $("#here").empty();
                  $(".card-title").text("Insert product Details");
            ...
            // functions for product type
            function TypeEdit() {
              var type = "true";
              $.ajax({
                url: "backend/inputConfig.php",
                type: "post",
                data: {
                  type: type
                },
            ...
            function Addnewtype() {
              var addnewtype = $("#addproducttype").val();
              $.ajax({
                url: "backend/Configfunction.php",
                type: "post",
                data: {
            ...
            function deletetype(deletetypeid) {
              $.ajax({
                url: "backend/Configfunction.php",
                type: "post",
                data: {
                ...
                success: function(data, status) {
                  ...
                  Viewtype2();
                  Viewsafety();
                  $('#successToast3').toast('show');
                }
              });
            }

            // functions for product specification 

            function editmodal2(id2) {
              var id2 = id2;
              $.ajax({
                url: "backend/fetchtype.php",
                type: "post",
                ...
                success: function(data, status) {
                  var Data = JSON.parse(data);
                  $("#editproductspec").val(Data.Product_Type2);
                  $("#hiddenedit2").val(Data.ID);
            ...
            function edittype2() {
              var newtype2 = $("#editproductspec").val();
              var editid2 = $("#hiddenedit2").val();
              $.ajax({
                url: "backend/Configfunction.php",
                type: "post",
                data: {
            ...
            function Addnewspec() {
              var addnewtype2 = $("#addproductspec").val();
              $.ajax({
                url: "backend/Configfunction.php",
                type: "post",
                data: {
                  addnewtype2: addnewtype2
                },
                success: function(data, status) {
                  Viewinput();
                  Viewunit();
            ...
            function deletespec(deletespecid) {
              $.ajax({
                url: "backend/Configfunction.php",
                type: "post",
                data: {
                  deletespecid: deletespecid
                },
                success: function(data, status) {
                  Viewinput();
                  Viewunit();
            ...
            // functio for product safety type 
            function editmodal3(id3) {
              var id3 = id3;
              $.ajax({
                url: "backend/fetchtype.php",
                type: "post",
                ...
                success: function(data, status) {
                  var Data = JSON.parse(data);
                  $("#editproductsafety").val(Data.Safety_Type);
                  $("#hiddenedit3").val(Data.ID);
            ...
            function edittype3() {
              var newtype3 = $("#editproductsafety").val();
              var editid3 = $("#hiddenedit3").val();
              $.ajax({
                url: "backend/Configfunction.php",
                type: "post",
                data: {
            ...
            function Addsafetymodal() {
              $("#addproductsafety").val('');
              $('#AddModal2').modal('show');
            }

            function Addnewsafety() {
              var addnewtype3 = $("#addproductsafety").val();
              $.ajax({
                url: "backend/Configfunction.php",
                type: "post",
                data: {
                  addnewtype3: addnewtype3
                },
                success: function(data, status) {
                  Viewinput();
                  Viewunit();
            ...
            function deletesafety(deletesafetyid) {
              $.ajax({
                url: "backend/Configfunction.php",
                type: "post",
                data: {
                  deletesafetyid: deletesafetyid
                },
                success: function(data, status) {
                  Viewinput();
                  Viewunit();
            ...
            // functio for product measuring unit
            function editmodal4(id4) {
              var id4 = id4;
              $.ajax({
                url: "backend/fetchtype.php",
                type: "post",
                ...
                success: function(data, status) {
                  var Data = JSON.parse(data);
                  $("#editproductunit").val(Data.Unit);
                  $("#hiddenedit4").val(Data.ID);
            ...
            function edittype4() {
              var newtype4 = $("#editproductunit").val();
              var editid4 = $("#hiddenedit4").val();
              $.ajax({
                url: "backend/Configfunction.php",
                type: "post",
                data: {
            ...
            function Addnewunit() {
              var addnewtype4 = $("#addproductunit").val();
              $.ajax({
                url: "backend/Configfunction.php",
                type: "post",
                data: {
                  addnewtype4: addnewtype4
                },
                success: function(data, status) {
                  Viewinput();
                  Viewunit();
