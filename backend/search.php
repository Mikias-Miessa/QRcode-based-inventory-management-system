...
if (isset($_POST['input'])) {
  ...
  $input = $_POST['input'];
  $sql = "(SELECT * FROM products WHERE Product_Name LIKE '%" . $_POST['input'] . "%') 
UNION (SELECT * FROM products WHERE Product_Type LIKE '%" . $_POST['input'] . "%') 
UNION (SELECT * FROM products WHERE SKU LIKE '%" . $_POST['input'] . "%')";
