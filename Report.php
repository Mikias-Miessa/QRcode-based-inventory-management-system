  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3    bg-warning" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" # " target="_blank">
        ...
        <!-- <img src="../assets/img/iv.png" class="navbar-brand-img h-100" alt="main_logo"> -->
      ...
      <div class="row">
        <div class=" mx-auto">
          <div class="card mt-4">
            ...
            <div class="card-body px-5 pb-4" id="here">
            </div>
            <div class="text-center">
              <button class="btn bg-gradient-info w-25 mb-0" type="button" data-target="infoToast" onclick="window.print()">Print Report</button>
            </div>
            <br>
          </div>
        </div>
