    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3    bg-warning" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-info " href="Outflow.php">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Stock Outflow</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Stock Outflow</h6>
                </nav>
                                        ...
                                        <div class="d-flex py-1">
                                            ...
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="text-sm font-weight-normal mb-1">
                                                    <span class="font-weight-bold">Alert</span> T-shirt capacity low in
                                                    stock
                                                </h6>
                                ...
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="javascript:;">
                                        <div class="d-flex py-1">
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="text-sm font-weight-normal mb-1">
                                                    <span class="font-weight-bold">Alert</span> Product one have
                                                    completed shelf time
                                                </h6>
                    ...
                    <div class="card-body px-4">
                        ...
                        <div class="row">
                            ...
                            <form class="col" id="form" method="post">
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        <input type="hidden" class="form-control" id="sku" placeholder="" required>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="productname" class="form-label">Product Name</label>
                                        <input type="text" class="form-control" id="productname" placeholder="product name here..." required>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="productType" class="form-label">Product Type</label>
                                        <input type="text" class="form-control" id="productType" placeholder="product type here..." required>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="shelfNumber" class="form-label">Shelf Number</label>
                                        <input type="text" class="form-control" id="shelfNumber" placeholder="shelf number here..." required>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="productquantity" class="form-label">Product Quantity</label>
                                        <input type="hidden" id="realquantity">
                                        <input type="number" class="form-control" id="productquantity" placeholder="product quantity here..." required min="0" data-parsley-lte="#realquantity">
                                    </div>
                                    <div class="col-md-12">
                                        <label for="issued_date" class="form-label">Issued Date</label>
                                        <input type="date" class="form-control" id="issued_date" placeholder="Issued date here..." required>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="issued_to" class="form-label">Issued To</label>
                                        <input type="text" class="form-control" id="issued_to" placeholder="Issued to..." required>
                                    </div>
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-info">Confirm Stock Out</button>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <div class="position-fixed top-1 end-1 z-index-2">
        ...
        <script type="text/javascript">
            function onScanSuccess(qrCodeMessage) {
                document.getElementById("sku").value = qrCodeMessage;
                var qrCodeMessage = qrCodeMessage;
                $.post("backend/Out.php", {
                    qrCodeMessage: qrCodeMessage
                }, function(data, status) {
                    var productData = JSON.parse(data);
                    $('#productname').val(productData.Product_Name);
                    $('#productType').val(productData.Product_Type);
                    $('#shelfNumber').val(productData.Shelf_Number);
                    $('#realquantity').val(productData.Quantity);
                });
