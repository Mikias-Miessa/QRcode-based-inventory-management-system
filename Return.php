  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-warning" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-info " href="Return.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Stock Inflow</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Stock Inflow</h6>
        </nav>
              ...
              <form class="col" id="form" method="post">
                <div class="row g-3">
                  ...
                  <div class="col-md-12">
                    ...
                    <input type="number" class="form-control" id="productquantity" placeholder="product quantity here..." required min="0">
                  </div>
                  <div class="col-md-12">
                    <label for="Stockindate" class="form-label">Return Date</label>
                    <input type="date" class="form-control" id="Stockindate" placeholder="Return Date here..." required>
                  </div>
                  <div class="col-md-12">
                    <label for="returnedby" class="form-label">Returned by</label>
                    <input type="text" class="form-control" id="returnedby" placeholder="Returned by..." required>
                  </div>
                  <div class="col-12">
